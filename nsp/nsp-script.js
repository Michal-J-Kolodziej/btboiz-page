const conf = {
    offsetTime: 1500, //A number of miliseconds that you have to wait to scroll page again
    ...
    hidingOutDots: false, //If 'true' dots will hide after a number of miliseconds given below
